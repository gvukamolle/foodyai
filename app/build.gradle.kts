...
android {
    ...
    composeOptions {
        kotlinCompilerExtensionVersion = "1.5.8" // Укажи версию компилятора, совместимую с твоим Kotlin
    }
    packaging {
        resources {
...
dependencies {
    ...
    implementation("io.coil-kt:coil-compose:2.6.0") // Используйте актуальную версию
